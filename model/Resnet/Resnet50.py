...
class Resnet50(torch.nn.Module):
    def __init__(self, input_channels, output_classes, image_size):
        ...
        self.block_2 = torch.nn.Sequential(
            Residual_Block(input_channels=64, mid_channels=64, output_channels=256, drop_out=0, activate_function='relu'),
            Residual_Block(input_channels=256, mid_channels=64, output_channels=256, drop_out=0, activate_function='relu'),
            Residual_Block(input_channels=256, mid_channels=64, output_channels=256, drop_out=0, activate_function='relu'),
        )
        self.block_3 = torch.nn.Sequential(
            Residual_Block(input_channels=256, mid_channels=128, output_channels=512, drop_out=0, activate_function='relu'),
            Residual_Block(input_channels=512, mid_channels=128, output_channels=512, drop_out=0, activate_function='relu'),
            Residual_Block(input_channels=512, mid_channels=128, output_channels=512, drop_out=0, activate_function='relu'),
            Residual_Block(input_channels=512, mid_channels=128, output_channels=512, drop_out=0, activate_function='relu'),
        )
        self.block_4 = torch.nn.Sequential(
            Residual_Block(input_channels=512, mid_channels=256, output_channels=1024, drop_out=0, activate_function='relu'),
            Residual_Block(input_channels=1024, mid_channels=256, output_channels=1024, drop_out=0, activate_function='relu'),
            Residual_Block(input_channels=1024, mid_channels=256, output_channels=1024, drop_out=0, activate_function='relu'),
            Residual_Block(input_channels=1024, mid_channels=256, output_channels=1024, drop_out=0, activate_function='relu'),
            Residual_Block(input_channels=1024, mid_channels=256, output_channels=1024, drop_out=0, activate_function='relu'),
            Residual_Block(input_channels=1024, mid_channels=256, output_channels=1024, drop_out=0, activate_function='relu'),
        ...
        self.block_5 = torch.nn.Sequential(
            Residual_Block(input_channels=1024, mid_channels=512, output_channels=2048, drop_out=0, activate_function='relu'),
            Residual_Block(input_channels=2048, mid_channels=512, output_channels=2048, drop_out=0, activate_function='relu'),
            Residual_Block(input_channels=2048, mid_channels=512, output_channels=2048, drop_out=0, activate_function='relu'),            
        )
